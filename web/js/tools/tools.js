define(function (require, exports, module) {
    ...
    var langs = {
        'zh_CN': {
            ...
            'register.activatedNoRequired': '请输入激活人编号',
            'register.activatedNoValid': '该玩家不存在或尚未激活',
            'register.success': '注册成功！等待激活后可登录系统！',
        ...
        'en_US': {
            ...
            'register.activatedNoRequired': 'Please input the user ID who can activate you',
            'register.activatedNoValid': 'The user is not exist or not be activated yet',
